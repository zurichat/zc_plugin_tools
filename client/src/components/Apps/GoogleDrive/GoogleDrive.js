      ...
      <div className=" flex w-full">
        ...
        <div className=" w-9/12 mb-2 px-8">
          ...
          <div className=" border-b w-full flex mb-4">
            <button onClick={() => setClicked("desc")} className={ `mr-6  border-b  px-2 ${clicked == "desc" ? "text-black border-green-600" : "text-gray-500"}`}>
              Description
            </button>
            <button onClick={() => setClicked("feat")} className={ `mr-6  border-b  px-2 ${clicked == "feat" ? "text-black border-green-600" : "text-gray-500"}`}>Features</button>
            <button onClick={() => setClicked("perm")} className={ `mr-6  border-b  px-2 ${clicked == "perm" ? "text-black border-green-600" : "text-gray-500"}`}>Permission</button>
            <button onClick={() => setClicked("sec")} className={ `mr-6  border-b  px-2 ${clicked == "sec" ? "text-black border-green-600" : "text-gray-500"}`}>
              {" "}
              Security and Compliance
            </button>
          </div>
          {clicked === "desc" ? <div className=" w-full bg-blue-500 rounded-md px-14 py-10">
