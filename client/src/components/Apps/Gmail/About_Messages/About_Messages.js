    ...
    return <>
        <div className="Start-title">
				...
				<div className="welcome-nav">
					<h4 onClick = {()=>{setClicked('messages')}}
                        className = {
                        clicked == "messages" ? "selected" : ""
                    }
                    >
						Messages
					</h4>

					<h4 onClick = {()=>{setClicked('about')}}
                        className = {
                        clicked == "about" ? "selected" : ""
                    }
                    >
						About
					</h4>
                ...
                <div>
                    <div className="gmail-about-section-infoblock">
                        ...
                        <div className="gmail-about-section-text">
                            ...
                            <br></br>
                            When to send email into Zuri:<br></br>
                            • Email chain getting too noisy? Send it into Zuri Chat where you can discuss quickly and move forward.
                            <br></br>• Have an idea you want to share with your team? Send it along to a relevant channel with a note about your insights.
                            <br></br>• Flag your teammates in Zuri Chat and use the email content to set context.
                            <br></br><br></br>
                            How the Add-On works:<br></br>
                            • Start by installing the Zuri for Gmail Add-On from the G Suite Marketplace
                            <br></br>• Open any email and click on the Slack icon in the right-hand side of your inbox
                            <br></br>• Choose the channel or person you’d like to forward the email to inside of Zuri Chat
                            <br></br>• Add a message and include attachments if you’d like
                            <br></br>• Voilà! The email is forwarded into Zuri where anyone in the channel or direct message you shared it to can see the email content and open attachments.
                            <br></br>
                            Please note that the following limits apply to emails shared via this app:<br></br>
                            • The combined headers and body of an email cannot be larger than 1MB.
                            <br></br> • When combined with attachments, an email cannot be larger than 30 MB.
