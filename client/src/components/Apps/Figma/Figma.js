...
const Figma = () => {
	...
	const vercelUrl =
		"https://www.figma.com/oauth?client_id=V2IvPlEApDfBT9uNS5Rbrf&redirect_uri=https://https://zc-plugin-tools-oz8hq3z3r-preshy-jones.vercel.app/authenticate/&scope=file_read&state=state&response_type=code";
	return (
		<div>
