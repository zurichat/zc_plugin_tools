...
import Image from '../assets/ZV_64LdGoao.png';
    ...
    <section className='github_home github_home_padding'>
      ...
      <div className={`github_home_main`}>
        <section className={`github_home_main-section1`}>
          ...
          <div className={'p-0.5 bg-githubGrey'}></div>
        ...
        <section className={`github_home_main-section2`}>
          ...
          <div className={`flex flex-col gap-4`}>
            ...
            <div className={`flex flex-col gap-8`}>
              <section className='bg-githubBlue flex flex-col gap-1 lg:gap-0 lg:items-center lg lg:flex-row text-white font-bold p-5 rounded'>
                <h2 className='lg:w-2/6 text-xl lg:text-2xl 2xl:text-4xl text-center lg:text-left'>
                  Bring your code to the conversations you care about
                </h2>
                <div className='order-first lg:order-last lg:w-4/6 rounded overflow-hidden'>
