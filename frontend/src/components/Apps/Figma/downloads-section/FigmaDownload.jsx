  ...
  return (
    <div className=" flex w-full my-5">
      <div className=" flex flex-col w-3/12  px-4">
        ...
        <button className="bg-green-500 py-2 my-2 text-white">
          Add to Zuri
        </button>
      ...
      <div className=" w-9/12 mb-2 px-8">
        <h1 className="font-extrabold text-2xl  mb-5">Figma</h1>
        ...
        {clicked === "desc" ? (
          <div className=" w-full bg-green-500 rounded-md px-14 py-10">
            ...
            <div className=" relative bg-white rounded-md w-10/12 m-auto px-32 py-5">
              ...
              <h3 className="text-sm">
                {" "}
                <span className="font-bold mr-2">Figma</span>{" "}
        ...
        {clicked === "desc" ? <div></div> : null}
      </div>
    </div>
  );
}

export default FigmaDownload;
