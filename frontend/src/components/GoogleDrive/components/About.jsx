    ...
    <section className="py-4">
      <div className="md:flex items-start mb-5 px-4">
        ...
        <div className="flex flex-col items-start p-0">
          <h2 className="font-fam3 font-semibold text-googledrive-header my-3 mx-0 text-xl leading-6">
            Google Drive
          </h2>
          ...
          <div className="">
            <ul className="font-fam3 list-inside list-disc">
              <li className="mb-1 font-normal text-googledrive-body text-sm leading-5">
              ...
              <li className="font-normal text-googledrive-body text-sm leading-5">
      ...
      <div>
        ...
        <div className="py-7 px-4 flex flex-wrap gap-4 border-googledrive-bdr border-b">
