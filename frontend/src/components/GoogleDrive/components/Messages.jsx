...
import HideFormatIcon from "../assets/hide-formatting.png";
import ShortcutIcon from "../assets/shortcut.png";
import LinksIcon from "../assets/links.svg";
import ItalicsIcon from "../assets/italic.svg";
  ...
  return (
    <div className={`${styles.height} w-full py-1`}>
      ...
      <div className="w-full h-1/6 border-2 border-gray-500 px-4 mx-4 rounded-sm">
        <textarea
          className="h-2/6 border-gray-700 outline-none mx-3 bg-transparent px-4"
          placeholder="Send a message to Google Drive"
        ></textarea>
